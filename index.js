...
FileStream.prototype.destroySoon = function () {
  this.end()
}
...
FileStream.prototype._processDelayed = function () {
  var self = this
  setImmediate(function () {
    self._process()
  })
...
FileStream.prototype.toString = function () {
  return 'level-fstream'
}

module.exports = function (db) {
  db.fileStream = db.createFileStream = function (options) {
    return new FileStream(options, db)
  }
}
